...
cl = LineClient(authToken='Ew6gKFNdVGYkaNh4qLI7.I5uTUVpiEjxG440n3qIGXW.beU8q9hXbXEcJQHssn+LoMv1D60ixjFT/Y0IfmXssQc=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EwbGR4RzT0WmEBPbjaG0.Uz8xn/+I1ydD9SJ3jdbsea.+L7XRz5N7Ni4BraT/TgbgqtogIZVN4k1i1cIye3nEXA=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='Ewf464tg0mhnKbX2ztG9.DrekgEgKonWsmqrnDFxBIq.ZtapXMcj/0DzarrQFfB8QbgRA4IzTiysyhdaJVsneUQ=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='Ewt68CzF0ZFu0wqi5Mva.lyW28mxy8Z6hyly3a1j8UG.8SdiIzx93PwQNLC4cTrLCoIU5O4ggG4ZNT1REiIKAD8=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kw = LineClient(authToken='EwFFsh6rapqE6XwYJC26.1rgLtloHiSG9aKRIjZWLTG.x6hxrv+xGDP6KcA4E9CQX8reQxA9BdLdlYWL0awsGnI=')
kw.log("Auth Token : " + str(kw.authToken))
channel4 = LineChannel(kw)
kw.log("Channel Access Token : " + str(channel4.channelAccessToken))

ks = LineClient(authToken='EwwpRS5tM9c9zjSRHi06.1VMpHFNizbgShgi7hOL9vG.w/wK1MAaGR+97rKQHTvzc3N6EEezQbE7lxd2vOPMFNU=')
ks.log("Auth Token : " + str(ks.authToken))
channel5 = LineChannel(ks)
ks.log("Channel Access Token : " + str(channel5.channelAccessToken))

sw = LineClient(authToken='EwqtUhEyzRViEdzgvszf.GOpX7phvL2KyRd/oUES1pW.615gDwCP+3/Z5qjmSMODpBbOpU5zcOJmiG4iQ6uMUfE=')
...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["u03028a2bba1298b8e213a870436030aa"]
owner = ["u03028a2bba1298b8e213a870436030aa"]
admin = ["u03028a2bba1298b8e213a870436030aa"]
staff = ["u03028a2bba1298b8e213a870436030aa"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
Dmid = kw.getProfile().mid
Emid = ks.getProfile().mid
Zmid = sw.getProfile().mid
KAC = [cl,ki,kk,kc,kw,ks]
ABC = [ki,kk,kc,kw,ks]
...
responsename4 = kw.getProfile().displayName
...
wait = {
    ...
    "selfbot":True,
    "mention":"Hayooloh!!!",
    "Respontag":"Tag tag-_- ngapain!",
    "welcome":"Selamat datang & betah",
    "comment":"Done like sayang",
    "message":"Terimakasih sudah add kak..open jasa protect group..",
    }
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path4 = kw.downloadObjectMsg(msg_id)
                     path5 = ks.downloadObjectMsg(msg_id)
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Mr.R") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "┃🇮🇩┃ ┃WSS┃ Family Grup Info\n\n┃🇮🇩┃ Nama Group : {}".format(G.name)+ "\n┃🇮🇩┃ ID Group : {}".format(G.id)+ "\n┃🇮🇩┃ Pembuat : {}".format(G.creator.displayName)+ "\n┃🇮🇩┃ Waktu Dibuat : {}".format(str(timeCreated))+ "\n┃🇮🇩┃ Jumlah Member : {}".format(str(len(G.members)))+ "\n┃🇮🇩┃ Jumlah Pending : {}".format(gPending)+ "\n┃🇮🇩┃ Group Qr : {}".format(gQr)+ "\n┃🇮🇩┃ Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🇮🇩┃ ┃Why So Serious BoT\n\n"+ma+"\nTotal「%s」List Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kw.sendMessage(msg.to,responsename4)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "┃WSS┃ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
...
#===========Hiburan============#
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      ...
                                      kw.sendMessage(midd, str(Setmain["RAmessage1"]))
                                      ks.sendMessage(midd, str(Setmain["RAmessage1"]))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              if True:
                                  cl.sendMessage(msg.to, "Wss suport: your id http://line.me/ti/p/~" + msgs)
...
#===========Protection============#
                        ...
                        elif 'wsspro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('wsspro ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
